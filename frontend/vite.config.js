    ...
    server: {
        proxy: {
            "/kestra-webhook": {
                ...
                changeOrigin: true,
                rewrite: function () { return "/api/v1/main/executions/webhook/sentinel.grid/sentinel_core/sentinel-grid-intake"; },
            },
            "/kestra-register-helper": {
                target: "http://localhost:8080",
                changeOrigin: true,
                headers: { Authorization: "Basic YWRtaW5Aa2VzdHJhLmlvOlNlbnRpbmVsMQ==" },
                rewrite: function () { return "/api/v1/main/executions/webhook/sentinel.grid/register_responder/register-responder"; },
            },
            "/kestra-location-ping": {
                target: "http://localhost:8080",
                changeOrigin: true,
                headers: { Authorization: "Basic YWRtaW5Aa2VzdHJhLmlvOlNlbnRpbmVsMQ==" },
                rewrite: function () { return "/api/v1/main/executions/webhook/sentinel.grid/responder_location_ping/location-ping"; },
            },
            "/kestra-accept-alert": {
                target: "http://localhost:8080",
                changeOrigin: true,
